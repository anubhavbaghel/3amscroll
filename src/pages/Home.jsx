...
import {
    ...
    Clock, ArrowDown, Eye, MessageSquare
} from 'lucide-react';
...
const Home = () => {
    ...
    const [onlineUsers, setOnlineUsers] = useState(3421);
    ...
    return (
        <div className="min-h-screen bg-[#050505] text-slate-200 font-sans selection:bg-purple-500/30 selection:text-purple-200 overflow-x-hidden">
            <SEO
                title="Home"
                description="Curating the digital void for the sleepless and the curious."
            ...
            <main className="pt-48 pb-20 px-6 max-w-7xl mx-auto">
                ...
                <section className="mb-24 animate-fade-in-up">
                    <div className="relative group rounded-[2.5rem] overflow-hidden bg-black border border-white/5 min-h-[500px] flex items-center transition-transform duration-700 hover:shadow-[0_0_50px_rgba(168,85,247,0.1)]">
                        ...
                        <div className="relative z-10 p-8 md:p-16 max-w-3xl">
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-8">
                                <button className="group px-8 py-4 bg-white text-black rounded-full font-black text-sm uppercase tracking-tighter flex items-center gap-2 hover:bg-purple-500 hover:text-white transition-all shadow-xl shadow-black/50 hover:shadow-purple-500/20 active:scale-95">
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="flex -space-x-3">
                                        {[1, 2, 3].map(i => (
                                            <div key={i} className="w-10 h-10 rounded-full border-2 border-black bg-zinc-800 overflow-hidden flex items-center justify-center relative z-10 hover:z-20 transition-all hover:scale-110">
                                                {i === 3 ? (
                ...
                <section className="mb-24">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {snacks.map((snack, i) => (
                            <div key={i} className="group relative bg-[#0D0D0D] border border-white/5 p-8 rounded-[2rem] hover:border-purple-500/50 hover:bg-[#121212] transition-all cursor-pointer hover:-translate-y-2 duration-300 will-change-transform">
                ...
                <section className="mb-24 py-24 border-y border-white/5 relative overflow-hidden px-4 md:px-0">
                    <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-indigo-500/5 blur-[120px] rounded-full -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                        <div className="lg:col-span-5">
                            ...
                            <button className="px-8 py-3 rounded-full border border-white/10 text-white hover:border-indigo-500 hover:text-indigo-400 transition-all font-bold text-xs uppercase tracking-widest active:scale-95">
                                Explore the Archive
                            </button>
                        </div>
                        ...
                        <div className="lg:col-span-7 space-y-6">
                            {[
                                ...
                                <div key={i} className={`group bg-white/[0.02] p-8 rounded-3xl border border-white/5 ${item.color} transition-all cursor-pointer flex justify-between items-center hover:bg-white/5`}>
                                    <div>
